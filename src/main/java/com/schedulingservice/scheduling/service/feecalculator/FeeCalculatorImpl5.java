...
@Component
public class FeeCalculatorImpl5 implements FeeCalculator {
    public static BigDecimal VALOR_ADICIONAL = new BigDecimal("0");
    public static BigDecimal PORCENTAGEM = new BigDecimal("4.7");
    public static int START_RANGE = 31;
    public static int END_RANGE = 40;
